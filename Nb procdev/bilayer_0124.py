...
### Inverse design ###
#PIC.Rectangle([(2.5*mm+x_extra+50*um+10*um, 3.1*mm), (9.5*mm, 4.9*mm)],97)
#PIC.Rectangle([(2.5*mm+x_extra+50*um+10*um, 5.0*mm), (9.5*mm, 6.9*mm)],99)
PIC.Rectangle([(2.5*mm+x_extra+50*um+10*um, 3.1*mm), (9.5*mm, 6.9*mm)],95)
PIC.bool_layer(98, 95, "xor", 100)
#PIC.bool_layer(96, 99, "and", 100) 
#PIC.bool_layer(96, 97, "and", 101)
#PIC.bool_layer(98, 96, "and", 101)  
