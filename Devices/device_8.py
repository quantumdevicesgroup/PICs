...
for i in range(11):
	for j in range(3):
		...
		x,y = chip.etch_tp((3*mm+2*um,4*mm+i*125*um+j*25*um),50*um,130*nm,300*nm)
...
for i in range(3):
	...
	xb,yb = chip.etch_tp((3*mm+2*um,5.5*mm+50*um*i),50*um,130*nm,300*nm)
	x,y = xb,yb
...
for i in range(3):
	...
	xb,yb = chip.etch_tp((3*mm+2*um,5.7*mm+50*um*i),50*um,130*nm,300*nm)
	x,y = xb,yb
...
for i in range(11):
	for j in range(3):
		...
		x,y = chip.etch_tp((10*mm-3*mm-2*um - 50*um ,4*mm+i*125*um+j*25*um),50*um,300*nm,130*nm)
...
for i in range(3):
	...
	xb,yb = chip.etch_tp((10*mm-3*mm-2*um-50*um,5.5*mm+50*um*i),50*um,300*nm,130*nm)
...
for i in range(3):
	...
	xb,yb = chip.etch_tp((10*mm-3*mm-2*um-50*um,5.7*mm+50*um*i),50*um,300*nm,130*nm)
	#xb,yb = chip.etch_tp((x-50*um,y),50*um,300*nm,130*nm)
	x,y = xb-50*um,yb
	dy = 300*nm*(0.5+0.5+1) + 2*250*nm + 5*um*2
	x,y = chip.etch_wg(([x,y],[x-400*um,y]))
