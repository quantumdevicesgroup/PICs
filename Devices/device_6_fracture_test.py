...
chip.deep_etch(3*mm)
chip.etch_markers([	(3.25*mm,4.5*mm)],200*um, 10*um)
...
for i in range(11):
	...
	for j in range(3):
		...
		chip.bool_layer(i + 200, i + 300,"xor",i + 400)

# for i in range(3):
# 	chip.change_write_layer(i+500)
...
chip.build('device_6_fracture_test')