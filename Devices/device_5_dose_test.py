...
chip.deep_etch(2*mm)
chip.etch_markers([	(2.25*mm,5*mm)],200*um, 10*um)
...
for i in range(11):
	for j in range(3):
		chip.change_write_layer(3*i + j + 100)
		...
		chip.bool_layer(3*i + j + 200,3*i + j + 300,"xor",3*i + j + 400)
